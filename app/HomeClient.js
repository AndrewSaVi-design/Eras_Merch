...
export default function HomeClient({ artistas = [], productos = [], banners = [], fondosMap = {} }) {
  ...
  // Match automático de fondo desde la Hoja 4
      ...
      {vista === 'colecciones' && (
        <div className="w-full flex flex-col items-center px-4 animate-in fade-in duration-500">
          ...
          <div className="w-full max-w-2xl flex flex-col md:flex-row gap-4 mb-12">
            ...
            <button onClick={() => artistasRef.current?.scrollIntoView({ behavior: 'smooth' })} className="bg-black text-white px-8 py-4 rounded-2xl text-[10px] font-black tracking-widest hover:bg-gray-800">VER ARTISTAS</button>
          </div>
